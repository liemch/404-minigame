...
export const GAMES = [
  ...
  /* ---------- Expansion 16–20 ---------- */
  {
    ...
    loader: () => import("../games/neon-pinball/index.js"),
    fullBleed: true,
    ownResults: true,
  },
  {
    ...
    loader: () => import("../games/gravity-flip/index.js"),
    fullBleed: true,
    ownResults: true,
  },
  {
    ...
    loader: () => import("../games/memory-matrix/index.js"),
    fullBleed: true,
    ownResults: true,
  },
  {
    ...
    loader: () => import("../games/cyber-goal/index.js"),
    fullBleed: true,
    ownResults: true,
  },
  {
    ...
    loader: () => import("../games/stealth-escape/index.js"),
    fullBleed: true,
    ownResults: true,
  },
];
